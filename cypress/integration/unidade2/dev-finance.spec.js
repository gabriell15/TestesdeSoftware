...
context('Dev Finances Agilizei', () => {
    ...
    it('Cadastrar saídas', () => { //oonly quer dizer q so quer fazer este teste deste trecho
           // cy.visit('https://dev-finance.netlify.app/')
        ...
        it('Verificar se estão na lista', () => {  // verificar se os que estão cadastrados estão na lista, no caso 2
        ...
        it('Verificar quantias de entrada', () => {
        ...
        it('Verificar quantias de saida', () => {
        ...
        it('Verificar quantia de total', () => {
            cy.get('.total').contains('Total')
            cy.get('.total').contains('R$ 42,00').should('be.visible')
            
        });

        it('Tamanho 2 que se espera pra lista neste momento', () => {
