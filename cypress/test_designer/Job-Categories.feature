Funcionalidade: Testes da tela de Job Categories
    ...
    Cenário: Redirecionamento para URL correta
        ...
        Quando clica na opção '<Job Categories>'
        Então deve ser redirecionado para a página de Job Categories

    Cenário: Editar trabalho
        Então a tela de Admin é apresentada
        Quando clica na opção '<Job>'
        E clica na opção '<Job Categories>'
